...
player2 = load_player(name="AlphaBetaNegamaxPlayer4",
                      storage="models/ab_negamax_player4", cls="AlphaBetaNegamaxPlayer", depth=4)
# player2 = load_player(name="MCTSRandomPlayer2",
#                       storage="models/mcts_random_player2", cls="MCTSRandomPlayer", C=1, simulations=1000)
end = time.process_time()
